  ...
  output_template: `【输出模板 (请严格使用以下 JSON 结构，并将 \${} 中的提示作为生成该字段的强制思考约束替换为实际数据)】
{
  "_chainOfThought": {
    "world_analysis": [
      "【时间确定】设定信息中的世界背景信息？当前的时间？背景设定中的剧情阶段？",
      "【世界线锚定】当前时间的背景信息？哪些因素会对接下来的推演造成影响？当前世界的客观演化信息，重要事件、势力版图？",
      ...
      "【推演原则】必须思考如何根据[言行平和化]和[角色独立性]描写角色的反应，防止角色神化主角或失去独立动机。务必注意剧情时间线，确保推演符合相关角色人设&世界背景。"
    ],
    "biz_asset_analysis": [
